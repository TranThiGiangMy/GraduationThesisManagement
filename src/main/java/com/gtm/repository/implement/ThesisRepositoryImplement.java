package com.gtm.repository.implement;
...
public class ThesisRepositoryImplement implements ThesisRepository {
    ...
    public Boolean updateThesis(int thesisId, Thesis thesis) {
        ...
        try {
            ...
            objThesis.setStartDate(thesis.getStartDate());
            objThesis.setComplateDate(thesis.getComplateDate());
            objThesis.setThesisStartDate(thesis.getThesisStartDate());
            objThesis.setThesisEndDate(thesis.getThesisEndDate());
            objThesis.setMajor(thesis.getMajor());
            objThesis.setSchoolYear(thesis.getSchoolYear());
            objThesis.setTopic(thesis.getTopic());
            objThesis.setComment(thesis.getComment());
