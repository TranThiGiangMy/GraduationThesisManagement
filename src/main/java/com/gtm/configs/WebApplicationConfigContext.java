package com.gtm.configs;

import com.gtm.converters.StringToLocalDateConverter;
import com.gtm.formatters.*;
import com.gtm.service.*;
import com.gtm.validators.*;
...
@ComponentScan(basePackages = {"com.gtm.controllers", "com.gtm.api", "com.gtm.repository", "com.gtm.service", "com.gtm.validators"})
public class WebApplicationConfigContext implements WebMvcConfigurer {
    ...
    public MessageSource messageSource() {
        ...
        source.setBasenames("messages/validator", "messages/layout");
